  ...
  return (
    <div className="ScrCreator">
      <form>
        ...
        <input id="title-input" type="text" placeholder="song title"></input>
        <select id="genre-input" defaultValue="">
        ...
        <textarea spellCheck="false" placeholder="Add your transcription in ABC notation..."></textarea>
